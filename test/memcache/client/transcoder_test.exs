defmodule Memcache.Client.TranscoderTest do
  use ExUnit.Case
  ...
  test "json transcoder encode_value" do
    Application.put_env(:memcache_ex, :transcoder, Memcache.Client.Transcoder.Json)
    ...
    Application.delete_env(:memcache_ex, :transcoder)
  end
  ...
  test "json transocder decode_value with opts" do
    Application.put_env(:memcache_ex, :transcoder, Memcache.Client.Transcoder.Json)
    Application.put_env(:memcache_ex, :transcoder_decode_opts, [keys: :atoms])
    
    assert %{test: "test"} == Memcache.Client.Transcoder.decode_value("{\"test\": \"test\"}", 0x0002)

    Application.delete_env(:memcache_ex, :transcoder)
    Application.delete_env(:memcache_ex, :transcoder_decode_opts)
  end

  test "erlang transcoder encode_value" do
    Application.put_env(:memcache_ex, :transcoder, Memcache.Client.Transcoder.Erlang)
