defmodule Memcache.Client do
  ...
  def start(_type, _args) do
    ...
    pool_args = [name: {:local, Memcache.Client.Pool},
                 ...
                 size: Application.get_env(:memcache_ex, :pool_size, @default_pool_size),
                 max_overflow: Application.get_env(:memcache_ex,
                                                   :pool_max_overflow, @default_pool_max_overflow)]
    worker_args = [host: Application.get_env(:memcache_ex, :host, @default_host),
                   port: Application.get_env(:memcache_ex, :port, @default_port),
                   auth_method: Application.get_env(:memcache_ex, :auth_method, @default_auth_method),
                   username: Application.get_env(:memcache_ex, :username, @default_username),
                   password: Application.get_env(:memcache_ex, :password, @default_password),
                   opts: Application.get_env(:memcache_ex, :socket_opts, @default_socket_opts),
                   timeout: Application.get_env(:memcache_ex, :timeout, @default_timeout)]
