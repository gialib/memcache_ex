defmodule Memcache.Client.Transcoder do
  ...
  def encode_value(value) do
    transcoder = Application.get_env(:memcache_ex, :transcoder, Memcache.Client.Transcoder.Raw)
...
defmodule Memcache.Client.Transcoder.Json do
  ...
  def encode_value(value) do
    opts = Application.get_env(:memcache_ex, :transcoder_encode_opts, [])
  ...
  def decode_value(value, @json_type_flag) do
    opts = Application.get_env(:memcache_ex, :transcoder_decode_opts, [])
